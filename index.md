...
I am **Wonseok Whi, M.D., Ph.D.**, currently working as a Clinical Assistant Professor at the **Department of Nuclear Medicine, Samsung Medical Center**.

My research bridges the gap between clinical nuclear medicine and computational analysis, with a special focus on brain connectomics and prognostic modeling using PET/CT.

## 🔬 Research Interests
1. **Brain Connectomics:** Hyperbolic embedding & Network analysis of fMRI
2. **Clinical Nuclear Medicine:** Prognostic value of PET/CT in Oncology
3. **Medical AI:** Deep learning-based image analysis
